...
stepwise_models_all <- data.frame(
  ...
  enabled = rep(TRUE, 8),
  model_label = c("Francis TA1.8 + CPUE MLE, REGW11, PTTP26, F25/F26 shared N7", "Francis TA1.8 + CPUE MLE, REGW1, PTTP26, F25/F26 shared N7", "Francis TA1.8 + CPUE MLE, REGW11, RR8/10, F25/F26 shared N7", "Francis TA1.8 + CPUE MLE, REGW1, RR8/10, F25/F26 shared N7", "DM G8PSSET Nmax25, REGW11, PTTP26, F25/F26 shared N7", "DM G8PSSET Nmax25, REGW1, PTTP26, F25/F26 shared N7", "DM G8PSSET Nmax25, REGW11, RR8/10, F25/F26 shared N7", "DM G8PSSET Nmax25, REGW1, RR8/10, F25/F26 shared N7"),
  ...
  change_axis = c(rep("full Francis TA1.8 LF divisors plus MFCL-equivalent normalized-lambda CPUE MLE sigma and shared seven-node F25/F26 selectivity", 4), rep("DM set-type G8PSSET grouping with Francis-calibrated Nmax25 cap and shared seven-node F25/F26 selectivity", 4)),
