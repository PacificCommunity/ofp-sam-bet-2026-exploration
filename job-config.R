...
stepwise_models_all <- data.frame(
  ...
  enabled = rep(TRUE, 8),
  model_label = c("Initial LF divisors + common CPUE sigma, REGW11, PTTP26, F25/F26 shared N7, common CPUE sigma", "Initial LF divisors + common CPUE sigma, REGW1, PTTP26, F25/F26 shared N7, common CPUE sigma", "Initial LF divisors + common CPUE sigma, REGW11, RR8/10, F25/F26 shared N7, common CPUE sigma", "Initial LF divisors + common CPUE sigma, REGW1, RR8/10, F25/F26 shared N7, common CPUE sigma", "DM G8PSSET Nmax25, REGW11, PTTP26, F25/F26 shared N7, common CPUE sigma", "DM G8PSSET Nmax25, REGW1, PTTP26, F25/F26 shared N7, common CPUE sigma", "DM G8PSSET Nmax25, REGW11, RR8/10, F25/F26 shared N7, common CPUE sigma", "DM G8PSSET Nmax25, REGW1, RR8/10, F25/F26 shared N7, common CPUE sigma"),
  ...
  change_axis = c(rep("initial robust-normal LF divisors, common R1-R5 CPUE sigma, and shared seven-node F25/F26 selectivity", 4), rep("DM set-type G8PSSET grouping with Francis-calibrated Nmax25 cap, common R1-R5 CPUE sigma, and shared seven-node F25/F26 selectivity", 4)),
