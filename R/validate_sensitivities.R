...
for (id in opr_ids[3:4]) {
  ...
  require_in_phase(lines, "1 342 25", phase1, id)
...
required_generated_terms <- c(
  ...
  "REG100", "SUB075", "SUB100", "G5PROC", "Nmax 25", "F12 PS.JP.1",
...
cat("DM OPR controls retain G5PROC, C estimation, Nmax 25, and phase order OPR/movement/regional scaling = 3/4/5.\n")
