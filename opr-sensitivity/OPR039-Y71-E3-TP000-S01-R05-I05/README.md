# OPR039-Y71-E3-TP000-S01-R05-I05
...
| Control | Value |
| --- | ---: |
| Annual temporal coefficients, parest 155 | 71 |
| Terminal window in calendar years, parest 202 | 3 |
| Season temporal coefficients, parest 217 | 1 |
| Region temporal coefficients, parest 216 | 5 |
| Region-season temporal coefficients, parest 218 | 5 |
| Terminal penalty flag, parest 397 | 0 |

Terminal penalty: OFF: parest 397=0 throughout.
Design role: parsimonious region and interaction temporal structure.
