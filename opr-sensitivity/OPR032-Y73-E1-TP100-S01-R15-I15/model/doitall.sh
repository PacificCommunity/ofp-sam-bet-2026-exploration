...
# OPR settings from the reviewed PDH model: 73-01-15-15.
  ...
  1 155 73  # orthogonal polynomial recruitment - year effect
  1 221 73  # compatibility state retained from the reviewed PDH par
  1 217 1   # orthogonal polynomial recruitment - season effect
  1 216 15  # orthogonal polynomial recruitment - region effect
  1 218 15  # orthogonal polynomial recruitment - region-season interaction effect
  1 202 1   # OPR end window: last 1 real years use lower-degree/constant-end basis
...
$program_path bet.frq 10.par 11.par -file - <<PHASE11
  1 155 73  # OPR year effect
  1 221 73  # compatibility state retained from the reviewed PDH par
  1 217 1   # OPR season effect
  1 216 15  # OPR region effect
  1 218 15  # OPR region-season interaction
  1 202 1   # terminal window in calendar years
  1 203 0
  1 210 0
  1 211 0
  1 212 0
