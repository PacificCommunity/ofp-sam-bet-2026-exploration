...
# OPR settings from the reviewed PDH model: 73-01-05-05.
  ...
  1 216 5  # orthogonal polynomial recruitment - region effect
  1 218 5  # orthogonal polynomial recruitment - region-season interaction effect
