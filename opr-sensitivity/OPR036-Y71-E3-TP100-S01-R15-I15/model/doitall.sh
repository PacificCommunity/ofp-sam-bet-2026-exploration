...
# OPR settings from the reviewed PDH model: 71-01-15-15.
  ...
  1 155 71  # orthogonal polynomial recruitment - year effect
  1 221 71  # compatibility state retained from the reviewed PDH par
