...
# Likelihood component settings
  ...
  1 342 20    # DM maximum LF sample-size control (Nmax20)
  ...
  -2 68 1  # DM LF group: Remaining longline
  -3 68 1  # DM LF group: Remaining longline
  -4 68 1  # DM LF group: Remaining longline
  -5 68 2  # DM LF group: Offshore longline
  -6 68 1  # DM LF group: Remaining longline
  -7 68 1  # DM LF group: Remaining longline
  -8 68 1  # DM LF group: Remaining longline
  -9 68 2  # DM LF group: Offshore longline
  -10 68 1  # DM LF group: Remaining longline
  -11 68 1  # DM LF group: Remaining longline
  -12 68 3  # DM LF group: Large-scale purse seine
  -13 68 6  # DM LF group: Other extraction
  -14 68 5  # DM LF group: Handline
  -15 68 5  # DM LF group: Handline
  -16 68 6  # DM LF group: Other extraction
  -17 68 4  # DM LF group: Domestic purse seine
  -18 68 4  # DM LF group: Domestic purse seine
  -19 68 3  # DM LF group: Large-scale purse seine
  -20 68 3  # DM LF group: Large-scale purse seine
  -21 68 6  # DM LF group: Other extraction
  -22 68 6  # DM LF group: Other extraction
  -23 68 6  # DM LF group: Other extraction
  -24 68 6  # DM LF group: Other extraction
  -25 68 3  # DM LF group: Large-scale purse seine
  -26 68 3  # DM LF group: Large-scale purse seine
  -27 68 3  # DM LF group: Large-scale purse seine
  -28 68 3  # DM LF group: Large-scale purse seine
  -29 68 7  # DM LF group: Index
  -30 68 7  # DM LF group: Index
  -31 68 7  # DM LF group: Index
  -32 68 7  # DM LF group: Index
  -33 68 7  # DM LF group: Index
...
# MFCL reads bet.reg_scaling when parest flag 77 is > 0.
  1 77 50    # MVN regional-scaling penalty weight
