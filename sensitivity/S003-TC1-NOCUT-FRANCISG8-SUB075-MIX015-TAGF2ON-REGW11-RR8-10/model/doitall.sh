...
# Deactivate any catch errors flags
  ...
  -999 15 0
  -999 13 0
# Survey fisheries retain source-fit CPUE sigma controls.
# fish flag 92 values are unchanged: F29-F33 = 35, 24, 21, 24, 23.
  -29 94 1 -29 92 35 -29 66 1  # Index R1, MFCL-equivalent sigma 0.381164501; raw-lambda sigma 0.370092043
  -30 94 1 -30 92 24 -30 66 1  # Index R2, MFCL-equivalent sigma 0.253889663; raw-lambda sigma 0.251060739
  -31 94 1 -31 92 21 -31 66 1  # Index R3, MFCL-equivalent sigma 0.196216684; raw-lambda sigma 0.196568241
  -32 94 1 -32 92 24 -32 66 1  # Index R4, MFCL-equivalent sigma 0.229608280; raw-lambda sigma 0.224340404
  -33 94 1 -33 92 23 -33 66 1  # Index R5, MFCL-equivalent sigma 0.212053422; raw-lambda sigma 0.213096834
...
# Index fisheries 29-33 are included; extraction labels need the 03 fishery map.
  ...
  -32 49 40  -32 50 40
  -33 49 40  -33 50 40
# BEGIN G8 GROUPED FRANCIS TA1.8 FLAG49 OVERRIDES
# Native integer realization of original Francis TA1.8 targets.
  -1 49 88  # Francis TA1.8 recommended LF divisor
  -2 49 88  # Francis TA1.8 recommended LF divisor
  -3 49 88  # Francis TA1.8 recommended LF divisor
  -4 49 88  # Francis TA1.8 recommended LF divisor
  -5 49 82  # Francis TA1.8 recommended LF divisor
  -6 49 88  # Francis TA1.8 recommended LF divisor
  -7 49 88  # Francis TA1.8 recommended LF divisor
  -8 49 88  # Francis TA1.8 recommended LF divisor
  -9 49 82  # Francis TA1.8 recommended LF divisor
  -10 49 88  # Francis TA1.8 recommended LF divisor
  -11 49 88  # Francis TA1.8 recommended LF divisor
  -12 49 139  # Francis TA1.8 recommended LF divisor
  -13 49 400  # Francis TA1.8 recommended LF divisor
  -14 49 118  # Francis TA1.8 recommended LF divisor
  -15 49 118  # Francis TA1.8 recommended LF divisor
  -16 49 400  # Francis TA1.8 recommended LF divisor
  -17 49 139  # Francis TA1.8 recommended LF divisor
  -18 49 139  # Francis TA1.8 recommended LF divisor
  -19 49 69  # Francis TA1.8 recommended LF divisor
  -20 49 45  # Francis TA1.8 recommended LF divisor
  -21 49 400  # Francis TA1.8 recommended LF divisor
  -22 49 400  # Francis TA1.8 recommended LF divisor
  -23 49 400  # Francis TA1.8 recommended LF divisor
  -24 49 400  # Francis TA1.8 recommended LF divisor
  -25 49 69  # Francis TA1.8 recommended LF divisor
  -26 49 69  # Francis TA1.8 recommended LF divisor
  -27 49 45  # Francis TA1.8 recommended LF divisor
  -28 49 45  # Francis TA1.8 recommended LF divisor
  -29 49 73  # Francis TA1.8 recommended LF divisor
  -30 49 73  # Francis TA1.8 recommended LF divisor
  -31 49 73  # Francis TA1.8 recommended LF divisor
  -32 49 73  # Francis TA1.8 recommended LF divisor
  -33 49 73  # Francis TA1.8 recommended LF divisor
# END G8 GROUPED FRANCIS TA1.8 FLAG49 OVERRIDES
