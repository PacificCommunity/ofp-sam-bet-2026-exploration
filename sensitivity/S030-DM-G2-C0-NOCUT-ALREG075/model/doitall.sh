...
# Likelihood component settings
  ...
  -1 68 1  # DM LF group: Extraction
  -2 68 1  # DM LF group: Extraction
  -3 68 1  # DM LF group: Extraction
  -4 68 1  # DM LF group: Extraction
  -5 68 1  # DM LF group: Extraction
  -6 68 1  # DM LF group: Extraction
  -7 68 1  # DM LF group: Extraction
  -8 68 1  # DM LF group: Extraction
  -9 68 1  # DM LF group: Extraction
  -10 68 1  # DM LF group: Extraction
  -11 68 1  # DM LF group: Extraction
  -12 68 1  # DM LF group: Extraction
  -13 68 1  # DM LF group: Extraction
  -14 68 1  # DM LF group: Extraction
  -15 68 1  # DM LF group: Extraction
  -16 68 1  # DM LF group: Extraction
  -17 68 1  # DM LF group: Extraction
  -18 68 1  # DM LF group: Extraction
  -19 68 1  # DM LF group: Extraction
  -20 68 1  # DM LF group: Extraction
  -21 68 1  # DM LF group: Extraction
  -22 68 1  # DM LF group: Extraction
  -23 68 1  # DM LF group: Extraction
  -24 68 1  # DM LF group: Extraction
  -25 68 1  # DM LF group: Extraction
  -26 68 1  # DM LF group: Extraction
  -27 68 1  # DM LF group: Extraction
  -28 68 1  # DM LF group: Extraction
  -29 68 2  # DM LF group: Index
  -30 68 2  # DM LF group: Index
  -31 68 2  # DM LF group: Index
  -32 68 2  # DM LF group: Index
  -33 68 2  # DM LF group: Index
