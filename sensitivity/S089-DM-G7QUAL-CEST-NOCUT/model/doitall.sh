...
# Likelihood component settings
  ...
  -12 68 5  # DM LF group: Japanese PS/PL
  -13 68 5  # DM LF group: Japanese PS/PL
  -14 68 6  # DM LF group: Other extraction
  -15 68 6  # DM LF group: Other extraction
  -16 68 6  # DM LF group: Other extraction
  -17 68 4  # DM LF group: Domestic purse seine
  -18 68 4  # DM LF group: Domestic purse seine
  -19 68 2  # DM LF group: Associated purse seine
  -20 68 3  # DM LF group: Unassociated purse seine
  ...
  -25 68 2  # DM LF group: Associated purse seine
  -26 68 2  # DM LF group: Associated purse seine
  -27 68 3  # DM LF group: Unassociated purse seine
  -28 68 3  # DM LF group: Unassociated purse seine
