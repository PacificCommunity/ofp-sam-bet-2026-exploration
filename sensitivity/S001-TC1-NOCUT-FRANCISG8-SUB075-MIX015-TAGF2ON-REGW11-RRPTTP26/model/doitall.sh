...
# fish flag 92 values are unchanged: F29-F33 = 35, 24, 21, 24, 23.
  -29 94 1 -29 92 35 -29 66 1  # Index R1, MFCL-equivalent sigma 0.381872619
  -30 94 1 -30 92 24 -30 66 1  # Index R2, MFCL-equivalent sigma 0.254966857
  -31 94 1 -31 92 21 -31 66 1  # Index R3, MFCL-equivalent sigma 0.197775601
  -32 94 1 -32 92 24 -32 66 1  # Index R4, MFCL-equivalent sigma 0.232217238
  -33 94 1 -33 92 23 -33 66 1  # Index R5, MFCL-equivalent sigma 0.212907454
...
# Likelihood component settings
  ...
  -999 49 20  # fallback; G8 pooled Francis TA1.8 overrides follow for F1-F33
   -1 49 88
   -2 49 88
   -3 49 88
   -4 49 88
