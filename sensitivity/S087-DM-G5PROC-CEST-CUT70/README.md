# BET 2026 S087-DM-G5PROC-CEST-CUT70 MFCL LF Dirichlet-multinomial noRE; all index LF retained; five observation-process groups separating longline extraction, large-scale purse seine, domestic purse seine, other extraction, and index fisheries; relative sample-size exponent estimated from PHASE2; DM tail compression min 5 classes; established F21/F22/F23 upper-bin cutoff above 70 cm; DM self-weighting/overdispersion sensitivity, not fixed duplicate-use correction
