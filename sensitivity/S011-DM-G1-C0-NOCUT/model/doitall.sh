...
# Likelihood component settings
  ...
  -1 68 1  # DM LF group: All LF
  -2 68 1  # DM LF group: All LF
  -3 68 1  # DM LF group: All LF
  -4 68 1  # DM LF group: All LF
  -5 68 1  # DM LF group: All LF
  -6 68 1  # DM LF group: All LF
  -7 68 1  # DM LF group: All LF
  -8 68 1  # DM LF group: All LF
  -9 68 1  # DM LF group: All LF
  -10 68 1  # DM LF group: All LF
  -11 68 1  # DM LF group: All LF
  -12 68 1  # DM LF group: All LF
  -13 68 1  # DM LF group: All LF
  -14 68 1  # DM LF group: All LF
  -15 68 1  # DM LF group: All LF
  -16 68 1  # DM LF group: All LF
  -17 68 1  # DM LF group: All LF
  -18 68 1  # DM LF group: All LF
  -19 68 1  # DM LF group: All LF
  -20 68 1  # DM LF group: All LF
  -21 68 1  # DM LF group: All LF
  -22 68 1  # DM LF group: All LF
  -23 68 1  # DM LF group: All LF
  -24 68 1  # DM LF group: All LF
  -25 68 1  # DM LF group: All LF
  -26 68 1  # DM LF group: All LF
  -27 68 1  # DM LF group: All LF
  -28 68 1  # DM LF group: All LF
  -29 68 1  # DM LF group: All LF
  -30 68 1  # DM LF group: All LF
  -31 68 1  # DM LF group: All LF
  -32 68 1  # DM LF group: All LF
  -33 68 1  # DM LF group: All LF
