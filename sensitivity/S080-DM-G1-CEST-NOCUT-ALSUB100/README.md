# BET 2026 S080-DM-G1-CEST-NOCUT-ALSUB100 MFCL LF Dirichlet-multinomial noRE; all index LF retained; one pooled LF group; relative sample-size exponent estimated from PHASE2; no DM tail compression; uncut LF data; DM self-weighting/overdispersion sensitivity, not fixed duplicate-use correction; age-length variant SUB100 from bet.2026.sub.basin.1.age_length
...
| LF grouping | G1: F1:F33 in one pooled LF group |
...
Paired base sensitivity: `S012-DM-G1-CEST-NOCUT`.
