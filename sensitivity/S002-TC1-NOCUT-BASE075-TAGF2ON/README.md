# BET 2026 S002-TC1-NOCUT-BASE075-TAGF2ON
...
`bet.ini` starts from `PacificCommunity/ofp-sam-2026-BET-YFT-build-ini@548de05aff9bdc96a9ee7a817bbfd8068020ba26` path `BET/ini.mix-period/bet.2026.mix-0.2.ini`. S002-TC1-NOCUT-BASE075-TAGF2ON restores all 98 `tag_flags(:,2)` values to the upstream value 1; its exact flag-column-2=0 control is `S001-TC1-NOCUT-BASE075-TAGF2OFF`; column 1 and every other INI value remain unchanged.
