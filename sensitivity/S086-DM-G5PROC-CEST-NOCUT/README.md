# BET 2026 S086-DM-G5PROC-CEST-NOCUT MFCL LF Dirichlet-multinomial noRE; all index LF retained; five observation-process groups separating longline extraction, large-scale purse seine, domestic purse seine, other extraction, and index fisheries; relative sample-size exponent estimated from PHASE2; DM tail compression min 5 classes; uncut LF data; DM self-weighting/overdispersion sensitivity, not fixed duplicate-use correction
