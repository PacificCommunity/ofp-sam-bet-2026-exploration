...
# Likelihood component settings
  ...
  1 342 25  # DM maximum LF effective-sample-size control (Nmax25)
  1 139 3     # set likelihood function for WF data to normal
  -999 49 20  # divide LF sample sizes by 20
  -1 68 1  # DM LF group: Main longline
  -2 68 1  # DM LF group: Main longline
  -3 68 1  # DM LF group: Main longline
  -4 68 1  # DM LF group: Main longline
  -5 68 2  # DM LF group: Offshore longline
  -6 68 1  # DM LF group: Main longline
  -7 68 1  # DM LF group: Main longline
  -8 68 1  # DM LF group: Main longline
  -9 68 2  # DM LF group: Offshore longline
  -10 68 1  # DM LF group: Main longline
  -11 68 1  # DM LF group: Main longline
  -12 68 3  # DM LF group: PS without set-type separation
  -13 68 7  # DM LF group: Other extraction
  -14 68 6  # DM LF group: Handline
  -15 68 6  # DM LF group: Handline
  -16 68 7  # DM LF group: Other extraction
  -17 68 3  # DM LF group: PS without set-type separation
  -18 68 3  # DM LF group: PS without set-type separation
  -19 68 4  # DM LF group: Associated purse seine
  -20 68 5  # DM LF group: Unassociated purse seine
  -21 68 7  # DM LF group: Other extraction
  -22 68 7  # DM LF group: Other extraction
  -23 68 7  # DM LF group: Other extraction
  -24 68 7  # DM LF group: Other extraction
  -25 68 4  # DM LF group: Associated purse seine
  -26 68 4  # DM LF group: Associated purse seine
  -27 68 5  # DM LF group: Unassociated purse seine
  -28 68 5  # DM LF group: Unassociated purse seine
  -29 68 8  # DM LF group: Index compositions
  -30 68 8  # DM LF group: Index compositions
  -31 68 8  # DM LF group: Index compositions
  -32 68 8  # DM LF group: Index compositions
  -33 68 8  # DM LF group: Index compositions
...
# SA28 baseline with independent seven-node F25/F26 associated-purse-seine selectivities; contiguous MFCL group labels.
  ...
  -25 24 25  # PS.ASSOC.WEST.3; independent seven-node selectivity
  -26 24 26  # PS.ASSOC.EAST.4; independent seven-node selectivity
...
# MFCL reads bet.reg_scaling when parest flag 77 is > 0.
  1 77 25    # MVN regional-scaling penalty weight
