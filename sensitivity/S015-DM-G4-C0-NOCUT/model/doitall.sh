...
# Likelihood component settings
  ...
  -1 68 1  # DM LF group: Longline
  -2 68 1  # DM LF group: Longline
  -3 68 1  # DM LF group: Longline
  -4 68 1  # DM LF group: Longline
  -5 68 1  # DM LF group: Longline
  -6 68 1  # DM LF group: Longline
  -7 68 1  # DM LF group: Longline
  -8 68 1  # DM LF group: Longline
  -9 68 1  # DM LF group: Longline
  -10 68 1  # DM LF group: Longline
  -11 68 1  # DM LF group: Longline
  -12 68 2  # DM LF group: Purse seine
  -13 68 3  # DM LF group: Other extraction
  -14 68 3  # DM LF group: Other extraction
  -15 68 3  # DM LF group: Other extraction
  -16 68 3  # DM LF group: Other extraction
  -17 68 2  # DM LF group: Purse seine
  -18 68 2  # DM LF group: Purse seine
  -19 68 2  # DM LF group: Purse seine
  -20 68 2  # DM LF group: Purse seine
  -21 68 3  # DM LF group: Other extraction
  -22 68 3  # DM LF group: Other extraction
  -23 68 3  # DM LF group: Other extraction
  -24 68 3  # DM LF group: Other extraction
  -25 68 2  # DM LF group: Purse seine
  -26 68 2  # DM LF group: Purse seine
  -27 68 2  # DM LF group: Purse seine
  -28 68 2  # DM LF group: Purse seine
  -29 68 4  # DM LF group: Index
  -30 68 4  # DM LF group: Index
  -31 68 4  # DM LF group: Index
  -32 68 4  # DM LF group: Index
  -33 68 4  # DM LF group: Index
