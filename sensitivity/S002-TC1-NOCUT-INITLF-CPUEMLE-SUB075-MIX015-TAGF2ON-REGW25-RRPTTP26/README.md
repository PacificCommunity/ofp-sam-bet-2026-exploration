# BET 2026 S002: Initial LF divisors and common CPUE sigma

## Model

- Model: S002-TC1-NOCUT-INITLF-CPUEMLE-SUB075-MIX015-TAGF2ON-REGW25-RRPTTP26
...
This branch restores the source robust-normal LF divisors and applies the common CPUE sigma and F25/F26 selectivity sensitivity. It retains the source model's robust-normal likelihood, 1% MFCL tail compression, no LF cutoff, SUB075 age-length data, MIX015 tag mixing, TAGF2ON, REGW25, and PTTP26 reporting-rate controls. Other than the F25/F26 selectivity sensitivity documented below, all remaining inputs and controls are unchanged.
